 ...
 *
 */
public class VideoEnableWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    private VideoEnableWebView webView;
    ...
    public VideoEnableWebChromeClient()
    {
    }
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnableWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView)
    {
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnableWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnableWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, VideoEnableWebView webView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
